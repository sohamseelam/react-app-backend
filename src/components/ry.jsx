  ...
  <div className="pooji">
    ...
    <div className="content">
      ...
      <section className="web container" id="about">
        ...
        <br /><br />
        <p style={{color: 'white'}}>GRIET has very active and enthusiastic cultural body named as “RHYTHMS “managed by students themselves under the guidance of faculty members.
          <br /><br />
          <br /><br />
          ...
          <section className="web container" id="accomplishments">
            ...
            <p style={{color: 'skyblue'}}> V Usha Rani Ma'am
              <br />
